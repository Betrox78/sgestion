inherited dmTPV: TdmTPV
  inherited cdsDatos: TRpClientDataset
    ...
    object cdsDatosTOTAL_ENTREGA: TFloatField
      FieldName = 'TOTAL_ENTREGA'
    end
    object cdsDatosTOTAL_CAMBIO: TFloatField
      FieldName = 'TOTAL_CAMBIO'
    end
  ...
  inherited qryDetalles: TZQuery
    Active = True
    SQL.Strings = (
      'select * from TPV_datos where id_TPV = :id_TPV')
    Params = <
      item
        DataType = ftString
        Name = 'id_TPV'
