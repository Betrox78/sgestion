inherited dmINGRESOS: TdmINGRESOS
  inherited cdsDatos: TClientDataSet
    object cdsDatosqryDetalles: TDataSetField
      FieldName = 'qryDetalles'
    end
    object cdsDatosID_INGRESOS: TWideStringField
      FieldName = 'ID_INGRESOS'
      Required = True
      Size = 38
    end
  ...
  inherited qryDetalles: TZQuery
    Active = True
    SQL.Strings = (
      'select * from INGRESOS_datos where id_INGRESOS = :id_INGRESOS')
    Params = <
      item
        DataType = ftString
        Name = 'id_INGRESOS'
