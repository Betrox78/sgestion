inherited dmALBARANES_COMPRA: TdmALBARANES_COMPRA
  inherited cdsDatos: TClientDataSet
    object cdsDatosqryDetalles: TDataSetField
      FieldName = 'qryDetalles'
    end
    object cdsDatosID_ALBARANES_COMPRA: TWideStringField
      FieldName = 'ID_ALBARANES_COMPRA'
      Required = True
      Size = 38
    end
  ...
  inherited qryDetalles: TZQuery
    ...
    SQL.Strings = (
        ...
        'select * from ALBARANES_COMPRA_datos where id_ALBARANES_COMPRA =' +
        ' :id_ALBARANES_COMPRA')
    Params = <
      item
        DataType = ftString
        Name = 'id_ALBARANES_COMPRA'
        ParamType = ptInput
      end>
    ParamData = <
      item
